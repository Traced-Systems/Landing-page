    ...
    return (
        ...
        <div className="container mx-auto flex items-center justify-center mt-20">
            <div
                ...
                className="!w-full sm:!w-[75vw] 2xl:!w-[66vw] sm:!max-w-[75vw] 2xl:!max-w-[66vw] overflow-y-auto   shadow-sm p-0"
            >
