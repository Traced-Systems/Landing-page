          ...
          <div className="max-w-4xl mx-auto pb-20">
            ...
            <div className="prose max-w-none text-gray-600">
              ...
              <ul className="list-disc pl-6 mb-6">
                <li className="mb-2">
                  Visit our website at https://tracedsystems.com/, or any
                  website of ours that links to this Privacy Notice.
                </li>
                <li className="mb-2">
                  Navigate to the Traced Systems website. Traced Systems is a
                  traceability and transparency solution that enhances
                  sustainability in supply chains. By leveraging blockchain and
                  digital identity technologies, Traced Systems enables
                  businesses to track product origins, lifecycle data, and
              ...
              <p className="mb-6">
                ...
                please contact us at farhad.rasouli@chromaway.com.
              </p>
              ...
              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-3 text-[#002A38]">
              ...
              <div id="section-1">
                ...
                <ul className="list-disc pl-6 mb-6">
                  ...
                  <li className="mb-2">
                    Country, location, and other technical data
                  </li>
                </ul>
                <p className="mb-6">
              ...
              <div id="section-3">
                ...
                <p className="mb-6">
                  ...
                  process your personal information. We may rely on the
              ...
              <div id="section-5">
                ...
                <p className="mb-6">
                  ...
                  tracked by Google Analytics across the Services, visit Google
                  Analytics Opt-Out. For more information on the privacy
              ...
              <div id="section-7">
                ...
                <p className="mb-6">
                  ...
                  at farhad.rasouli@chromaway.com.
                </p>
              </div>
              ...
              <div id="section-8">
                ...
                <ol className="list-decimal pl-6 mb-6">
                  ...
                  <li className="mb-2">
                    If applicable, request data portability.
                  </li>
                  <li className="mb-2">
                ...
                <p className="mb-6">
                  ...
                  object to the processing of your personal information. You can
                  make such a request by contacting us by using the contact
                ...
                <p className="mb-6">
                  ...
                  information, you have the right to complain to your Member
                ...
                <p className="mb-6">
                  ...
                  any time. You can withdraw your consent by contacting us using
                ...
                <p className="mb-6">
                  ...
                  of the processing before its withdrawal, nor will it affect
              ...
              <div id="section-10">
                ...
                <p className="mb-6">
                  ...
                  changes, we may notify you by prominently posting a notice of
                  such changes or by sending you a notification. We encourage
