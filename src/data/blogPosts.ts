...
export const blogPosts: BlogPost[] = [
    ...
    },
  {
    ...
    fullContent: {
      ...
      sections: [
        {
          heading: "About Lighthouse MASSIV",
          content:
...

  {
    ...
    fullContent: {
      ...
      sections: [
        {
          heading: "September 2nd, 2025",
          content:
            "The three companies, respectively from Switzerland, Sweden and Denmark, all active in the lifecycle of lithium-based batteries, have joined forces to work on the Digital Product Passport (DPP), which will facilitate the tracking of batteries during their entire lifetime.",
        },
        {
          heading: "Tracking the lifecycle",
          content:
            "The life of a lithium-based battery cell can be diverse, from its manufacture to the end of its life, sometimes being used in multiple applications. However, tracking where it comes from and what it has been through is not an easy task. With the increasing use of batteries, along with new EU requirements, tracking the cell’s journey with precise information is becoming essential. This is the challenge that Evolium, Cling and Traced have decided to address, forming a partnership to assess the usage of the DPP to improve battery lifecycle management.",
        },
        {
          heading: "Facilitating the implementation of EU legislation",
          content:
        ...
        {
          heading: "More transparency and traceability for batteries",
          content:
        ...
        {
          heading: "Reshaping the future of batteries",
          content:
        ...
        questions: [
          {
            ...
            answer:
              "Blockchain partnerships drive innovation, adoption, and interoperability while improving security and regulatory compliance.",
          },
          {
            question: "How do blockchain companies attract the right partners?",
            answer:
              "Companies with cutting-edge technology, clear value propositions, and strong ecosystem support build successful partnerships.",
          },
          {
            question: "What challenges do blockchain partnerships face?",
            answer:
              "Regulatory uncertainty, interoperability issues, and industry misconceptions are key challenges that need to be addressed.",
          },
          {
            question:
              "How do Web3-native partnerships differ from enterprise blockchain collaborations?",
            answer:
              "Web3-native partnerships move quickly due to shared knowledge of tokenomics, NFTs, and governance, while enterprises require structured onboarding, clear ROI, and regulatory compliance.",
          },
          {
            question:
