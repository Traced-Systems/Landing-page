          ...
          <div className="pt-24 px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex justify-center">
                <img
                  src="/lovable-uploads/b3b186f8-bc2a-4d3d-916f-bb04dee5239e.png"
              ...
              <div className="prose max-w-none mb-12">
                <p className="text-gray-600 mb-4">
                  Ready to transform your business with a Digital Product Passport? Join our growing list of success stories.
                </p>
