              ...
              {post.fullContent ? <>
                  <div className="flex items-center gap-2 mb-6">
                    {post.title === "The Blueprint for a Successful Blockchain Partner Ecosystem" ? <>
                        <img src="/lovable-uploads/0d25c486-df3a-4a98-b070-691da893d470.png" alt="Kiflo" className="h-8" />
                        <span className="text-gray-600">
                          Written by{" "}
                          <a href="https://www.kiflo.com/" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600">
                            Kiflo
                          </a>
                        </span>
                      </> : <>
                        <img src="/lovable-uploads/a163e1df-6783-427e-940a-22d1f8c80d11.png" alt="Traced Systems" className="w-12 h-12" />
                        <span className="text-gray-600">
                          Written by Traced Systems x{" "}
                          <a href="https://trace4value.se/" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600">
                            TRACE4VALUE + SwePass
                          </a>
                        </span>
                      </>}
                  ...
                  <div className="flex justify-center">
                    <img src={post.image} alt={post.title} className="w-[40vw] object-cover rounded-lg mb-8" />
                  </div>
                  ...
                  <div className="prose max-w-none mb-12">
                    ...
                    {post.fullContent.sections.map((section, index) => <section key={index} className="mb-12">
                        ...
                        {section.quote && <blockquote className="border-l-4 border-blue-500 pl-4 my-6 italic text-gray-700">
                            {section.quote}
                          </blockquote>}
                      </section>)}
