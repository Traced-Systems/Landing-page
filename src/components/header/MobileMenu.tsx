...
const MobileMenu = ({
  ...
  return <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent side="top" className="w-full h-[100vh] lg:hidden pt-16 bg-white" onSwipeRight={() => setIsOpen(false)} swipeDirection="right" swipeThreshold={50}>
        <Button variant="ghost" size="icon" onClick={() => setIsOpen(false)} className="absolute right-4 top-4 hover:bg-gray-100 bg-white shadow-md flex items-center gap-2 px-[42px] py-[18px]">
