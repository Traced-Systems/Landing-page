          ...
          <div className="px-8 space-y-16">
            ...
            <div className="relative h-[300px]">
              <img 
                ...
                alt="Factory" 
                className="absolute right-0 w-64 h-[330px] object-cover rounded-lg" 
              />
              <div className="absolute left-0 right-64 top-[15px] bg-white rounded-lg p-8 shadow-lg">
            ...
            <div className="relative h-[300px]">
              <img 
                ...
                alt="Business" 
                className="absolute left-0 w-64 h-[330px] object-cover rounded-lg" 
              />
              <div className="absolute left-64 right-0 top-[15px] bg-white rounded-lg p-8 shadow-lg">
